...
void CrearPiramideTriangularParaRotar()
{
	unsigned int indices_piramide_triangular[] = {
			0,1,2,
			1,3,2,
...
int main()
{
	...
	CrearPiramideTriangularParaRotar();//índice 5 en MeshList
	CreateShaders();
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//Pyraminx------------------------------------------------------------------------------------------------------------------
		//Transformación Global (E, R, T)
		glm::mat4 globalRotation = glm::mat4(1.0f);
		globalRotation = glm::translate(globalRotation, glm::vec3(0.0f, 0.0f, -4.0f)); 
		...
		//Piramide triangular negra de base-----------------------------------------------------------------------------------------
		model = globalRotation; // Empezamos desde la rotación global
		...
		//Cara azul-----------------------------------------------------------------------------------------------------------------
		glm::mat4 sideRotation = glm::rotate(globalRotation, glm::radians(120.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));

		//Piramide 1----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.03f, 0.04f, 0.21f)); // Subí ligeramente Y a 0.04f
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 2----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.175f, 0.04f, -0.055f));
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 3----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.32f, 0.04f, -0.31f));
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 4----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.18f, 0.29f, -0.215f));
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 5----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.03f, 0.29f, 0.03f));
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 6----------------------------------------------------------------------------------------------------------------
		model = globalRotation;
		model = glm::translate(model, glm::vec3(0.025f, 0.55f, -0.135f));
		model = glm::scale(model, glm::vec3(0.27f, 0.27f, 0.27f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Piramide 1----------------------------------------------------------------------------------------------------------------
		model = globalRotation; // Reiniciamos a la rotación global
